...
let permisos = localStorage.getItem('PUU'); // Traemos los valores de si tiene o no permisos el usuario.
/**
...
/************************************************************************************* */
        ...
        Nom_apertura.addEventListener('click', function(e) {
            ...
            e.preventDefault();
            // Con la variable de localstorage revisamos si el usuario tiene el permisos para finalizar pasos.
            if(permisos === 0 || permisos === "0" || permisos === false){
